export const metadata = {
  title: 'GoDyrect — Find and share business opportunities',
  description: 'GoDyrect is a marketplace for discovering, sharing, and discussing businesses and business opportunities.'
};
...
export default function HomePage() {
  return <main className="home-shell">
    <section className="home-hero">
      ...
      <div className="home-hero__actions"><a className="account-primary" href="/explore">Explore opportunities</a><a className="home-hero__secondary" href="/about">How GoDyrect works</a></div>
